...
| 1.5 | Glissando (sliding a finger across keys) | P0 | Previous note releases, new note sounds |
...
| 2.5 | Sustain pedal (CC 64) | P0 | Holds released keys until pedal up |
...
| 3.7 | Cathedral reverb, adjustable | P0 | Freeverb-style, 8 combs + pre-delay; drawer slider walks dry chapel → full cathedral (persisted) |
...
| 3.11 | Transposition | P0 | -6..+6 semitones from the drawer; shown on the console when active; General Cancel resets |
| 3.12 | Historical tunings | P2 | Future |
...
| 4.3 | Side drawer | P0 | Quick guide, transpose, sample-set links, GitHub issues, credits |
| 4.4 | Keep screen on while playing | P0 | `FLAG_KEEP_SCREEN_ON` |
| 4.5 | Persist the console | P0 | Registration, accessories, volume, transpose and pistons survive restarts |
| 4.7 | Combination pistons (4) | P0 | Tap = recall, long-press = store, console style |
