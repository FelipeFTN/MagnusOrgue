...
// Release signing lives in an untracked keystore.properties next to the
// keystore itself. Without it, release builds
// simply come out unsigned - so clones and CI still build fine.
